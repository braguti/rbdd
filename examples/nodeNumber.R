...
for (line_number in 1:(axtls_length - 1)) {
	...
	close(fileCon)
	axtls_exp = new_variable_from_expression("output_axtls.cnf", bdd_name = "axtls")
	apply_bdd(axtls_exp, bdd_name = "axtls")
	reorder_bdd("none", bdd_name = "axtls")
	number_nodes_axtls_none[index] = get_node_num(bdd_name = "axtls")
	reorder_bdd("sift", bdd_name = "axtls")
	number_nodes_axtls_sift[index] = get_node_num(bdd_name = "axtls")
	reorder_bdd("random", bdd_name = "axtls")
	number_nodes_axtls_rand[index] = get_node_num(bdd_name = "axtls")
	index = index + 1
	done_bdd(bdd_name = "axtls")
}
...
for (line_number in 1:(fiasco_length - 1)) {
	...
	writeLines(liness, fileCon)
	close(fileCon)
	fiasco_exp = new_variable_from_expression("output_fiasco.cnf", bdd_name = "fiasco")
	apply_bdd(fiasco_exp, bdd_name = "fiasco")
	reorder_bdd("none", bdd_name = "fiasco")
	number_nodes_fiasco_none[index] = get_node_num(bdd_name = "fiasco")
	reorder_bdd("sift", bdd_name = "fiasco")
	number_nodes_fiasco_sift[index] = get_node_num(bdd_name = "fiasco")
	reorder_bdd("random", bdd_name = "fiasco")
	number_nodes_fiasco_rand[index] = get_node_num(bdd_name = "fiasco")
	index = index + 1
	done_bdd(bdd_name = "fiasco")
}
...
for (line_number in 1:(uClibc_length - 1)) {
	...
	writeLines(liness, fileCon)
	close(fileCon)
	uClibc_exp = new_variable_from_expression("output_uclibc.cnf", bdd_name = "uClibc")
	apply_bdd(uClibc_exp, bdd_name = "uClibc")
	reorder_bdd("none", bdd_name = "uClibc")
	number_nodes_uClibc_none[index] = get_node_num(bdd_name = "uClibc")
	reorder_bdd("sift", bdd_name = "uClibc")
	number_nodes_uClibc_sift[index] = get_node_num(bdd_name = "uClibc")
	reorder_bdd("random", bdd_name = "uClibc")
	number_nodes_uClibc_rand[index] = get_node_num(bdd_name = "uClibc")
	index = index + 1
	done_bdd(bdd_name = "uClibc")
}
