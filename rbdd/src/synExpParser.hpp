...
#line 52 "synExpParser.hpp" // lalr1.cc:377
...
namespace kconf {
#line 129 "synExpParser.hpp" // lalr1.cc:377
  ...
  private:
    ...
    std::map<int, synExp*> synExpMap;
  };

  // Symbol number corresponding to token number t.
  inline
  synExpParser::token_number_type
  synExpParser::yytranslate_ (token_type t)
  {
    static
  ...
  inline
  synExpParser::syntax_error::syntax_error (const location_type& l, const std::string& m)
    : std::runtime_error (m)
    , location (l)
  {}
  ...
  template <typename Base>
  inline
  synExpParser::basic_symbol<Base>::basic_symbol ()
    : value ()
  {}

  template <typename Base>
  inline
  synExpParser::basic_symbol<Base>::basic_symbol (const basic_symbol& other)
    : Base (other)
    , value ()
    , location (other.location)
  {
      switch (other.type_get ())
    {
      case 3: // T_MAINMENU
      case 4: // T_MENU
        value.copy< kconf_id* > (other.value);
        break;
  ...
  template <typename Base>
  inline
  synExpParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const semantic_type& v, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {
  ...
  template <typename Base>
  synExpParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const location_type& l)
    : Base (t)
    , value ()
    , location (l)
  {}
  ...
  template <typename Base>
  synExpParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const kconf_id* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  synExpParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const synExp* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  inline
  void
  synExpParser::basic_symbol<Base>::clear ()
  {
    // User destructor.
  ...
  inline
  bool
  synExpParser::basic_symbol<Base>::empty () const
  {
  ...
  // by_type.
  inline
  synExpParser::by_type::by_type ()
    : type (empty_symbol)
  {}

  inline
  synExpParser::by_type::by_type (const by_type& other)
    : type (other.type)
  {}

  inline
  synExpParser::by_type::by_type (token_type t)
    : type (yytranslate_ (t))
  {}

  inline
  void
  synExpParser::by_type::clear ()
  {
    type = empty_symbol;
  }
  ...
  inline
  void
  synExpParser::by_type::move (by_type& that)
  {
    type = that.type;
    that.clear ();
  }
  ...
  inline
  int
  synExpParser::by_type::type_get () const
  {
    return type;
  }

  inline
  synExpParser::token_type
  synExpParser::by_type::token () const
  {
  ...
  synExpParser::make_T_EOF (const location_type& l)
  {
    return symbol_type (token::T_EOF, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_MAINMENU (const kconf_id*& v, const location_type& l)
  {
    return symbol_type (token::T_MAINMENU, v, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_MENU (const kconf_id*& v, const location_type& l)
  {
    return symbol_type (token::T_MENU, v, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_LITERAL (const std::string& v, const location_type& l)
  {
    return symbol_type (token::T_LITERAL, v, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_SYMBOL (const std::string& v, const location_type& l)
  {
    return symbol_type (token::T_SYMBOL, v, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_TRUE (const location_type& l)
  {
    return symbol_type (token::T_TRUE, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_FALSE (const location_type& l)
  {
    return symbol_type (token::T_FALSE, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_MODULE (const location_type& l)
  {
    return symbol_type (token::T_MODULE, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_IF (const location_type& l)
  {
    return symbol_type (token::T_IF, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_THEN (const location_type& l)
  {
    return symbol_type (token::T_THEN, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_ELSE (const location_type& l)
  {
    return symbol_type (token::T_ELSE, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_UNEQUAL (const location_type& l)
  {
    return symbol_type (token::T_UNEQUAL, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_CLOSEPAREN (const location_type& l)
  {
    return symbol_type (token::T_CLOSEPAREN, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_OPENPAREN (const location_type& l)
  {
    return symbol_type (token::T_OPENPAREN, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_EOL (const location_type& l)
  {
  ...
  synExpParser::symbol_type
  synExpParser::make_T_OR (const location_type& l)
  {
    return symbol_type (token::T_OR, l);
  }

  synExpParser::symbol_type
  synExpParser::make_T_AND (const location_type& l)
  {
  ...
  synExpParser::symbol_type
  synExpParser::make_T_NOT (const location_type& l)
  {
...
#endif // !YY_YY_SYNEXPPARSER_HPP_INCLUDED
